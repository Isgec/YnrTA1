<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_taCities.aspx.vb" Inherits="EF_taCities" title="Edit: Cities" %>
<asp:Content ID="CPHtaCities" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabeltaCities" runat="server" Text="&nbsp;Edit: Cities"></asp:Label>
</div>
...
<asp:ObjectDataSource 
  ...
  runat = "server" >
<SelectParameters>
  <asp:QueryStringParameter DefaultValue="0" QueryStringField="CityID" Name="CityID" Type="String" />
</SelectParameters>
</asp:ObjectDataSource>
</div>
</div>
