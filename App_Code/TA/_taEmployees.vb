...
Namespace SIS.TA
  ...
  Partial Public Class taEmployees
    ...
    Public Shared Function taEmployeesInsert(ByVal Record As SIS.TA.taEmployees) As SIS.TA.taEmployees
      Dim _Rec As SIS.TA.taEmployees = SIS.TA.taEmployees.taEmployeesGetNewRecord()
      With _Rec
      ...
      End With
      Return SIS.TA.taEmployees.InsertData(_Rec)
    End Function
    Public Shared Function InsertData(ByVal Record As SIS.TA.taEmployees) As SIS.TA.taEmployees
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "sptaEmployeesInsert"
        ...
        End Using
      End Using
      CreateWebUserAndAuthorization(Record)
      Return Record
    End Function
    ...
    Public Shared Function taEmployeesDelete(ByVal Record As SIS.TA.taEmployees) As Int32
      Dim _Result as Integer = 0
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.StoredProcedure
          Cmd.CommandText = "sptaEmployeesDelete"
